...
<script type="text/javascript">
	...
	function deleteLink(){
		...
		if(selectedRows.length==0){
		 ...
		 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${pageContext.request.contextPath}/link/delete.do",{ids:ids},function(result){
						if(result.success){
	...
	function openLinkModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${pageContext.request.contextPath}/link/save.do?id="+row.id;
	 }
...
<table id="dg" title="友情链接管理" class="easyui-datagrid"
   ...
   url="${pageContext.request.contextPath}/link/list.do" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		...
   		<th field="linkEmail" width="200" align="center">联系邮箱</th>
 ...
 <div id="dlg" class="easyui-dialog" style="width:500px;height:250px;padding: 10px 20px"
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		...
   		<tr>
   			<td>联系邮箱：</td>
   			<td><input type="text" id="linkEmail" name="linkEmail" class="easyui-validatebox" validtype="email" required="true" style="width: 250px"/></td>
   		</tr>
   		<tr>
   			<td>友情链接排序：</td>
   			<td><input type="text" id="orderNum" name="orderNum" class="easyui-numberbox" required="true" style="width: 60px"/>&nbsp;(友情链接根据排序序号从小到大排序)</td>
   		</tr>
   	</table>
   </form>
 </div>
